...
public abstract class Nivel {
    ...
    private final int TIME_WITH_PODER;
     ...
     * @param fruta 
     */
    public Nivel(int nivel, String FILE_NAME, int MIN_DOTS_TO_SPAWN_FRUTINHA, int DELTA_DOTS_TO_SPAWN_FRUTINHA, int TIME_WITH_PODER, Class<? extends Frutinha> fruta) {
        this.nivel = nivel;
